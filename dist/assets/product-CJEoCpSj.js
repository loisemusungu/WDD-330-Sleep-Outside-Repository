import { g as n, s as e } from "./utils-DTA1AWa-.js";
function d(a) {
...
function i(a) {
  let t = n("so-cart") || [];
  if (t.find((r) => r.id === a.id)) {
    alert("This item is already in your cart.");
    return;
  }
  t.push(a), e("so-cart", t), alert("Product added to cart!");
}
async function u(a) {
  const t = await s.findProductById(a.target.dataset.id);
  i(t);
}
